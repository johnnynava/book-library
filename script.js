...
let title = document.querySelector("input#book_name");
let author = document.querySelector("input#author_name");
let pages = document.querySelector("input#pages");
let read = document.querySelector("select#status");
...
pages.addEventListener("input", () => {
  if (pages.validity.patternMismatch) {
    pages.setCustomValidity(
      "Type the correct number of pages in numerical digits"
    );
